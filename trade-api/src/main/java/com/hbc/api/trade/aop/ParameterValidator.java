	...
	public Object basicParameterCheck(ProceedingJoinPoint jp) throws Throwable {
		...
		for (Object arg : args) {
			if (arg instanceof BindingResult) {
				...
				rs.setStatus(Integer.parseInt("400"+CommonReturnCodeEnum.PARAM_ERROR.getCode()));
				...
				if (result.hasErrors()) {
					...
					rs.setMessage(CommonReturnCodeEnum.PARAM_ERROR.getMessage()+errMsgMap.toString());
