...
@RequestMapping("fund")
@RestController
public class MISBankCardController {

	@Autowired private FundBankCardService bankCardService;
	@Autowired private GFundWithdrawService withdrawService;

	@RequestMapping(value = "v1.0/e/account/bank/list", method = RequestMethod.GET, produces = "application/json; charset=utf-8")
	...
	@RequestMapping(value = "v1.0/e/account/bank/remove", method = RequestMethod.POST, produces = "application/json; charset=utf-8")
	...
	@RequestMapping(value = "v1.0/e/account/history/list", method = RequestMethod.GET, produces = "application/json; charset=utf-8")
