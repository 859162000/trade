...
public class ThirdOrderConfirmQueueStarter {
	...
	public static void main(String[] args) {
		...
		Logger log = LoggerFactory.getLogger(ThirdOrderConfirmQueueStarter.class);
		...
		while (true) {
			try {
				thirdOrderQueueService.execThirdConfirmQueue() ;
