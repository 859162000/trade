...
import com.hbc.data.trade.transfer.mapping.hbcfund.gen.bean.FinalGuidefinanceCriteria.Criteria;
import com.hbc.data.trade.transfer.mapping.hbcfund.gen.bean.FinalGuidefinanceCriteria.Criterion;
import com.hbc.data.trade.transfer.mapping.hbcfund.gen.bean.FinalGuidefinanceCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class FinalGuidefinanceSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(FinalGuidefinanceCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("`guidefinance`");
     ...
     * @mbggenerated
     */
    public String deleteByExample(FinalGuidefinanceCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("`guidefinance`");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(FinalGuidefinance record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("`guidefinance`");
        ...
        if (record.getIsvalidated() != null) {
            sql.VALUES("isValidated", "#{isvalidated,jdbcType=TINYINT}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(FinalGuidefinanceCriteria example) {
        SQL sql = new SQL();
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("guideFinanceId");
        } else {
        ...
        sql.SELECT("currency");
        sql.SELECT("swift");
        sql.SELECT("isValidated");
        sql.SELECT("type");
        sql.SELECT("status");
        sql.SELECT("updated_at");
        sql.SELECT("deleted_at");
        sql.SELECT("created_at");
        sql.FROM("`guidefinance`");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FinalGuidefinance record = (FinalGuidefinance) parameter.get("record");
        FinalGuidefinanceCriteria example = (FinalGuidefinanceCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("`guidefinance`");
        ...
        if (record.getIsvalidated() != null) {
            sql.SET("isValidated = #{record.isvalidated,jdbcType=TINYINT}");
        }
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(FinalGuidefinance record) {
        SQL sql = new SQL();
        sql.UPDATE("`guidefinance`");
        ...
        if (record.getIsvalidated() != null) {
            sql.SET("isValidated = #{isvalidated,jdbcType=TINYINT}");
        }
        ...
        sql.WHERE("guideFinanceId = #{guidefinanceid,jdbcType=INTEGER}");
     ...
     * @mbggenerated
     */
    protected void applyWhere(SQL sql, FinalGuidefinanceCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
