...
import com.hbc.data.trade.transfer.mapping.hbcfinal.gen.bean.FinalOrderTransferCriteria.Criteria;
import com.hbc.data.trade.transfer.mapping.hbcfinal.gen.bean.FinalOrderTransferCriteria.Criterion;
import com.hbc.data.trade.transfer.mapping.hbcfinal.gen.bean.FinalOrderTransferCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class FinalOrderTransferSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(FinalOrderTransferCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("`ordertransfer`");
     ...
     * @mbggenerated
     */
    public String deleteByExample(FinalOrderTransferCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("`ordertransfer`");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(FinalOrderTransfer record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("`ordertransfer`");
     ...
     * @mbggenerated
     */
    public String selectByExample(FinalOrderTransferCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FinalOrderTransfer record = (FinalOrderTransfer) parameter.get("record");
        FinalOrderTransferCriteria example = (FinalOrderTransferCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("`ordertransfer`");
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(FinalOrderTransfer record) {
        SQL sql = new SQL();
        sql.UPDATE("`ordertransfer`");
     ...
     * @mbggenerated
     */
    protected void applyWhere(SQL sql, FinalOrderTransferCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
