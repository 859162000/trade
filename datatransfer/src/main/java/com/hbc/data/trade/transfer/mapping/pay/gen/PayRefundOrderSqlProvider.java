...
import com.hbc.data.trade.transfer.mapping.pay.gen.bean.PayRefundOrderCriteria.Criteria;
import com.hbc.data.trade.transfer.mapping.pay.gen.bean.PayRefundOrderCriteria.Criterion;
import com.hbc.data.trade.transfer.mapping.pay.gen.bean.PayRefundOrderCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PayRefundOrderSqlProvider {
     ...
     * @mbggenerated
     */
    public String countByExample(PayRefundOrderCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("`pay_refund_order`");
     ...
     * @mbggenerated
     */
    public String deleteByExample(PayRefundOrderCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("`pay_refund_order`");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbggenerated
     */
    public String insertSelective(PayRefundOrder record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("`pay_refund_order`");
        ...
        if (record.getFreezeId() != null) {
            sql.VALUES("freeze_id", "#{freezeId,jdbcType=VARCHAR}");
        }
        
        if (record.getMerRefundNo() != null) {
            sql.VALUES("mer_refund_no", "#{merRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getSerRefundNo() != null) {
            sql.VALUES("ser_refund_no", "#{serRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getBusiRefundNo() != null) {
            sql.VALUES("busi_refund_no", "#{busiRefundNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSerNotifyStatus() != null) {
            sql.VALUES("ser_notify_status", "#{serNotifyStatus,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated
     */
    public String selectByExample(PayRefundOrderCriteria example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("freeze_id");
        sql.SELECT("mer_refund_no");
        sql.SELECT("ser_refund_no");
        sql.SELECT("busi_refund_no");
        sql.SELECT("amount");
        sql.SELECT("subject");
        sql.SELECT("body");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PayRefundOrder record = (PayRefundOrder) parameter.get("record");
        PayRefundOrderCriteria example = (PayRefundOrderCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("`pay_refund_order`");
        ...
        if (record.getFreezeId() != null) {
            sql.SET("freeze_id = #{record.freezeId,jdbcType=VARCHAR}");
        }
        
        if (record.getMerRefundNo() != null) {
            sql.SET("mer_refund_no = #{record.merRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getSerRefundNo() != null) {
            sql.SET("ser_refund_no = #{record.serRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getBusiRefundNo() != null) {
            sql.SET("busi_refund_no = #{record.busiRefundNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSerNotifyStatus() != null) {
            sql.SET("ser_notify_status = #{record.serNotifyStatus,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated
     */
    public String updateByPrimaryKeySelective(PayRefundOrder record) {
        SQL sql = new SQL();
        sql.UPDATE("`pay_refund_order`");
        ...
        if (record.getFreezeId() != null) {
            sql.SET("freeze_id = #{freezeId,jdbcType=VARCHAR}");
        }
        
        if (record.getMerRefundNo() != null) {
            sql.SET("mer_refund_no = #{merRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getSerRefundNo() != null) {
            sql.SET("ser_refund_no = #{serRefundNo,jdbcType=VARCHAR}");
        }
        
        if (record.getBusiRefundNo() != null) {
            sql.SET("busi_refund_no = #{busiRefundNo,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSerNotifyStatus() != null) {
            sql.SET("ser_notify_status = #{serNotifyStatus,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated
     */
    protected void applyWhere(SQL sql, PayRefundOrderCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
