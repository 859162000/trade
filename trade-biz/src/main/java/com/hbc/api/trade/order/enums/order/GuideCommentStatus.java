 ...
 * @author Jongly Ran
 */
public enum GuideCommentStatus {
	/** 0: 未评论 */
	UNSCORED(0,"未评论"),
	...
	GuideCommentStatus(int value,String name){
		this.value = value;
		this.name = name;
	}
	
	public static GuideCommentStatus getType(Integer type) {
		if(type != null) {
			for( GuideCommentStatus userCommentStatus : values()) {
