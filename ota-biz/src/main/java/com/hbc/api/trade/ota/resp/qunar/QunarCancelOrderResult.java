 ...
 * @author Jongly Ran
 */
public class QunarCancelOrderResult extends QunarResult{
	 ...
	 * 
	 */
	public QunarCancelOrderResult() {
		super();
	}
	
	public QunarCancelOrderResult(String qOrderId) {
	 ...
	 * @param errorMsg
	 */
	public QunarCancelOrderResult(int code, String errorMsg) {
		super(code, errorMsg);
	}
